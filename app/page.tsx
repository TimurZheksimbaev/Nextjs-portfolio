        ...
        <div className="portfolio-body">
          <header className="header-section">
            <label className="name">
              Timur <span className="span">Zheksimbaev</span>
            </label>
            <ul className="menu">
              <li>
              ...
              <li>
                <Link href="/comic">Get Comic</Link>
              </li>
            </ul>
          </header>
          ...
          <main className="hero">
            <div className="hero-content">
              ...
              <p>
                Student at Innopolis University on Cybersecurity track.
                Currently have internship on DevOps engineering position. I am
                interested in Fullstack development, DevOps, Blockchain and
                System design. Checkout all of my projects on Github.
              </p>
            </div>
              ...
              <section className="contacts">
                ...
                <div className="contact-item">
                  <a href="https://t.me/mastehorny1">
                    <img
                      width="20"
                      src="https://static-00.iconduck.com/assets.00/telegram-icon-2048x2048-ns3mbgh4.png"
                    />
                  </a>
                </div>
